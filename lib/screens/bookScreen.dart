import 'package:lancul/UIview/chewie_list_item.dart';
import 'package:flutter/material.dart';
import 'package:video_player/video_player.dart';
import 'package:lancul/UIview/SlidingCardsView.dart';
...
class BookScreen extends StatefulWidget {
  ...
  const BookScreen({Key key, this.animationController}) : super(key: key);
  @override
    ...
    listViews.add(
      ChewieListItem(
        videoPlayerController: VideoPlayerController.network(
            'https://lanculapp.netlify.com/video.mp4'),
        looping: true,
      ),
    );
